...
namespace JobFinder.DataAccess.Migrations
{
    ...
    [Migration("20240527100000_First")]
    partial class First
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JobFinder.Domain.Entities.Concretes.Job", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("JobFinder.Domain.Entities.Concretes.User", b =>
                {
            ...
            modelBuilder.Entity("JobFinder.Domain.Entities.Concretes.Job", b =>
                {
                    b.HasOne("JobFinder.Domain.Entities.Concretes.User", null)
                        .WithMany("Jobs")
